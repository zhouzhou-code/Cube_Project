...
#define MAG_XOUT_L				0X03	//磁力计值,X轴低8位寄存器
#define MAG_XOUT_H				0X04  //磁力计值,X轴高8位寄存器
#define MAG_YOUT_L				0X05  //磁力计值,Y轴低8位寄存器
#define MAG_YOUT_H				0X06  //磁力计值,Y轴高8位寄存器
#define MAG_ZOUT_L				0X07  //磁力计值,Z轴低8位寄存器
#define MAG_ZOUT_H				0X08  //磁力计值,Z轴高8位寄存器
